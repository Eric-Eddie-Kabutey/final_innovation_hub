...
const articles = [
  ...
  },
  {
    ...
    image:
      "https://kedrus.io/wp-content/uploads/2024/11/Building-a-personal-support-system.jpeg",
    category: "Insights",
  ...
  },
  {
    ...
    image:
      "https://kedrus.io/wp-content/uploads/2024/10/Fintech-in-Africa-1.jpeg",
  ...
  },
  {
    id: 4,
    title:
      "Finding Your Big Idea – How to Identify and Validate Promising Ideas",
    image:
      "https://kedrus.io/wp-content/uploads/2024/10/Finding-your-bigidea-.jpeg",
    category: "Product",
  ...
  },
  {
    id: 5,
    title:
      "The Art of Storytelling: Crafting Your Founder Story and Brand Narrative",
    image:
      "https://kedrus.io/wp-content/uploads/2024/10/art-of-storytelling-.jpeg",
    category: "Enterprise",
  ...
  },
  {
    id: 6,
    title:
      "Transitioning From Idea to Execution: Turning Your Vision into Reality",
    image:
      "https://kedrus.io/wp-content/uploads/2024/10/idea-to-execution.jpeg",
    category: "Product",
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full text-sm font-medium transition-all duration-300 transform hover:scale-105 ${
                activeFilter === filter
                  ...
                  : "bg-white text-gray-800 border border-gray-300 hover:border-red-500 hover:bg-rose-50"
              }`}
            >
              {filter}
            </button>
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {article.tags.map((tag, index) => (
                      <span
                        key={index}
                        className="bg-rose-100 text-red-800 px-2 py-1 rounded text-xs font-medium"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  <button className="mt-auto w-full bg-gradient-to-r from-red-600 to-rose-600 text-white rounded-full px-6 py-3 text-sm font-semibold hover:from-red-700 hover:to-rose-700 transition-all duration-300 transform hover:scale-105 shadow-md hover:shadow-lg">
                    Read Article
                  </button>
                </div>
              </div>
