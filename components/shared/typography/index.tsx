...
const typoVariants = cva("overflow-wrap overflow-hidden leading-normal", {
  variants: {
    typo: {
      ...
      "header-1-bold": "xl:text-[61px] md:text-[50px] xs:text-[40px] text-[30px] xl:leading-[85px] xs:leading-[65px] leading-[40px] font-bold",
      ...
      "header-6-regular": "xl:text-[20px] md:text-[18px] sm:text-[20px] text-[18px] xl:leading-[24px] leading-[23px] font-normal",
      "header-6-medium": "xl:text-[20px] md:text-[18px] sm:text-[20px] text-[18px] xl:leading-[24px] leading-[23px] font-medium",
      "header-6-semibold": "xl:text-[20px] md:text-[18px] sm:text-[20px] text-[18px] xl:leading-normal leading-[23px] font-semibold",
